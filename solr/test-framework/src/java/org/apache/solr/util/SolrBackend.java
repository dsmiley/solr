...
public interface SolrBackend extends AutoCloseable {
   ...
   * if it already exists. Cloud backends ({@link org.apache.solr.cloud.MiniSolrCloudCluster},
   * {@link RemoteSolrBackend}) honour {@code numShards} and {@code replicationFactor}; single-node
   * backends ({@link JettySolrRunner}, {@link EmbeddedSolrBackend}) ignore those fields and treat
