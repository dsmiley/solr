 ...
 *
 * <p>Note: this is very similar to {@code
 * io.opentelemetry.api.incubator.propagation.PassThroughPropagator} but we create a new trace, and
 * that one purely propagates.
 */
